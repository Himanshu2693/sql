...
UPDATE DEPOSIT SET AMOUNT = AMOUNT + (AMOUNT*10/100) WHERE CNAME IN (SELECT CNAME FROM CUSTOMERS12 WHERE CITY='NAGPUR') AND BNAME IN(SELECT BNAME FROM BRANCH WHERE CITY='BOMBAY'); 
